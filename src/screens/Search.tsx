...
import { searchInfections, infectionSelector } from '../features/intectionSlice';
...
export const SeachScreen: React.FC = () => {
  const navigate = useNavigate();
  const [error, setError] = useState<string | undefined>(undefined);

  const createdUser = useAppSelector(infectionSelector);
